...
const handleSave = () => {
    onSave(name, species, breed, color, address, weight, isVaccinated, gender, age, status);
    return name;
  };
  ...
  return (
    <Typography padding={3}>
      ...
      <FormControl>
        ...
        <Input id="species" onChange={(e) => setSpecies(e.target.value)} aria-describedby="my-helper-text" />
      </FormControl>

      <FormControl>
        <InputLabel htmlFor="breed">Порода</InputLabel>
        <Input id="breed" onChange={(e) => setBreed(e.target.value)} aria-describedby="my-helper-text" />
      </FormControl>

      <FormControl>
        <InputLabel htmlFor="color">Окрас</InputLabel>
        <Input id="color" onChange={(e) => setColor(e.target.value)} aria-describedby="my-helper-text" />
      </FormControl>

      <FormControl>
        <InputLabel htmlFor="address">Адрес</InputLabel>
        <Input id="address" onChange={(e) => setAddress(e.target.value)} aria-describedby="my-helper-text" />
      </FormControl> 
